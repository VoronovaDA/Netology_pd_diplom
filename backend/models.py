...
class User(AbstractUser):
    ...
    username = models.CharField(
        ...
        error_messages={
            "unique": _("A user with that full_name already exists."),
        },
        blank=True,
    )
    ...
    def __str__(self):
        return f"{self.email}, {self.first_name} {self.last_name} {self.surname}"
...
class Shop(models.Model):
    ...
    filename = models.FileField(
        verbose_name="Файл", upload_to="uploads/", null=True, blank=True
    )
...
class Order(models.Model):
    ...
    state = models.CharField(
        verbose_name="Статус", default="basket", choices=STATE_CHOICES, max_length=15
    )
